...
"""
Mask R-CNN evaluation over the COCO subset.

CLI:
    python src/experiments/run_maskrcnn.py \
        --subset data/subsets/subset_200.json \
        --output results/maskrcnn_results.json \
...
from src.models.maskrcnn_predictor import MaskRCNNPredictor
...
def run(args):
    ...
    model = MaskRCNNPredictor(device=device, score_threshold=args.score_threshold)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default="results/maskrcnn_results.json")
